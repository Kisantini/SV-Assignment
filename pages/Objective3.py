...
st.info("""
- States with high rape cases also show elevated kidnapping/abduction rates.  
- Positive correlations suggest interconnected socio-legal issues.  
- Further study can identify regional and policy-level influences.
""")
